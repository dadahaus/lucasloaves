...
<script type="text/javascript">
  ...
  const thisSection = document.querySelector(".product-grid-target"); // TARGET NEW CONTAINER
  let thisRow = "";
  let productDetails = "";
  ...
  let imageContainer = createContainerImage("images/breadMakingClass.jpg"),
    textContainer = createContainerText({
      ...
      linkButton: {
        hyperlink: "breadMakingClass.php",
  ...
  textContainer = createContainerText({
    ...
    ul: ["No Store/Commercial yeast", "Hand kneaded and shaped in-house", "Prepared over 14 - 17 hours", "Organic flour", "Easy to digest"],
    linkButton: {
      hyperlink: "aboutUs.php",
      buttonClass: "btn btn-lg btn-outline-primary",
      buttonText: "Go to Page"
    }
  });
